...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd('grim -o "$(slurp -d)" - | wl-copy'))
hl.bind(
	mainMod .. " + Y",
	hl.dsp.exec_cmd(
		'grim -g "$(slurp -d)" - | satty --filename - --fullscreen --output-filename ~/Pictures/Screenshots/satty-$(date+%Y%m%d-%H%M).png'
	)
)
